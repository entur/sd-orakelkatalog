combine_prompt_template_v2 = """
    ...
    Your answer should include the title of each relevant dataset, its link, and why they match the question posed by the user.
    ...
    Refer to the user directly, but without a goodbye message at the end.
    Give the answer in Markdown.
    Transform each relevant dataset title to a markdown link pointing to the dataset on data.norge.no.
